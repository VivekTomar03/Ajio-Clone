...
export default function Payment() {
  ...
  return (
    <>
    <main id='m' style={{border:"1px solid gray",borderRadius:"10px",fontWeight:"700",margin:"2em auto",width:"420px",marginTop:"70px"}}>
      ...
      <button id='btn'>PAY₹{new Intl.NumberFormat('en-IN',{maximumSignificantDigits:3}).format(end)}</button>
          ...
          {load?<Spinner size='xl' position="absolute" marginLeft="45%" top="200px" color='black' />:<Spinner style={{display:"none"}} size='xl' position="absolute" marginLeft="100px" top="200px" color='#6e3290'/>}
      <div id='ps' style={{display:"none"}} >
          <img src="https://www.graduationsource.com/media/wysiwyg/thank-you-icon.gif" style={{margin:"auto"}} alt="" />
