...
const MensHomepage = () => {
  ...
  >
    ...
    <Box>
      <Image
        src="https://assets.ajio.com/cms/AJIO/WEB/D-MHP-StylesInTheSpotlight.jpg"
        alt="heading"
    ...
    <Box>
      <Image
        src="https://assets.ajio.com/cms/AJIO/WEB/D-MHP-SponsoredBrands-header.jpg"
        alt="heading"
        w={{ base: "100%", md: "100%", lg: "100%" }}
        onMouseEnter={(e) => {
          e.target.style.transform = "scale(1.05)";
