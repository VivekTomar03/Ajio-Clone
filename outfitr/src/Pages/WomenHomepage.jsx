...
import SliderF1 from '../Slider/SliderF1';
import SliderF2 from '../Slider/SliderF2';
import SliderF3 from '../Slider/SliderF3';
import {Link as RouterLink} from "react-router-dom"
import SliderF4 from '../Slider/SliderF4';
import SliderF5 from '../Slider/SliderF5';
const WomenHomepage = () => {
  return (
    <div
    style={{
  ...
  >
    ...
    <Box>
      <Image
        src="https://assets.ajio.com/cms/AJIO/WEB/WHP-D-topbannercarousel-sectionheader.jpg"
        alt="heading"
    ...
    <Box>
      <Image
        src="https://assets.ajio.com/cms/AJIO/WEB/WHP-D-sponsorbrands-sectionheader.jpg"
        alt="heading"
        w={{ base: "100%", md: "100%", lg: "100%" }}
        onMouseEnter={(e) => {
          e.target.style.transform = "scale(1.05)";
    ...
    <RouterLink to={"/product"}><SliderF3 /></RouterLink>
    <Box>
      <Image
        src="https://assets.ajio.com/cms/AJIO/WEB/WHP-D-dailybannercarousel-sectionheader.jpg"
        alt="heading"
        w={{ base: "100%", md: "100%", lg: "100%" }}
        onMouseEnter={(e) => {
